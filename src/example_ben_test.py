...
single.columns = single.iloc[0]     #trying to get headers recognized by calls in 'define initial coditions' portion of script
#new_single = single[1:]
#single = new_single
...
H0 = single[single['organism']=='Pro_HLII']['rep1'].iloc[0]          #rep1 instead of abundance
N0 = float(single[single['organism']=='Pro_HLII']['rep1'].iloc[-1]) - float(H0)
